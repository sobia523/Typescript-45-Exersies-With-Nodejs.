...
//using if and eise-if condition
if (alienColor === "green") {
...
if (alienColor3 === "green") {
    ...
    console.log("you shot down yellow ailen you have earned 10 points");
}
else if (alienColor3 === "red") {
    console.log("you shot down red ailen you have earned 15 points");
}
